...
import Migration0055 from "./Migrations/055_ForkPullRequestFilesViewedCompatibility.ts";
import Migration0056 from "./Migrations/056_ForkAutoSettleDisabledAtCompatibility.ts";
...
const migrationEntries = [
  ...
  [55, "ForkPullRequestFilesViewedCompatibility", Migration0055],
  [56, "ForkAutoSettleDisabledAtCompatibility", Migration0056],
] as const;
