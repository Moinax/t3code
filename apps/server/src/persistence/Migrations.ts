...
import Migration0048 from "./Migrations/048_ProjectionThreadSessionStatusDetail.ts";
import Migration0049 from "./Migrations/049_ForkMigrationCompatibility.ts";
...
export const migrationEntries = [
  ...
  [48, "ProjectionThreadSessionStatusDetail", Migration0048],
  [49, "ForkMigrationCompatibility", Migration0049],
] as const;
