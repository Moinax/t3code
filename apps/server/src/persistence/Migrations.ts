...
import Migration0051 from "./Migrations/051_ForkMigrationCompatibility.ts";
import Migration0052 from "./Migrations/052_ProjectionThreadsActiveOrderKeyCompatibility.ts";
...
const migrationEntries = [
  ...
  [51, "ForkMigrationCompatibility", Migration0051],
  [52, "ProjectionThreadsActiveOrderKeyCompatibility", Migration0052],
] as const;
