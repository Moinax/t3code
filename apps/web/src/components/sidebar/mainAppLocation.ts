...
// Settings, Usage, Pull Requests, and Fork Updates replace the sidebar utility
// row with a Back button. Everything else is the main app. Legacy
// `/projects/<key>` links redirect into settings, so they count too and are
// never remembered.
